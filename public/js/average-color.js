function addImage(file) {
  ...
  img.onload = function() {
    ...
    element.querySelector('.hex').textContent = 'Average Color : ' + hexStr;
    element.querySelector('.hsl').textContent = 'Average Hue : ' + Math.round(hsl.h * 360);

    element.querySelector('.hue').value =  Math.round(hsl.h * 360);
